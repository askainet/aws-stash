...
def main():
    ...
    parser.add_argument('-f', '--force', action='store_true', help='Force overwrite existing value')
    parser.add_argument('-d', '--description', default=None, help='Add a description to the parameter')
    parser.add_argument('-k', '--kms', default='aws/ssm', help='KMS key alias to encrypt the value')
    parser.add_argument('-c', '--copy', action='store_true', help='Copy value to the clipboard instead of showing it')
    parser.add_argument('-o', '--output', choices=['text', 'json', 'export'], default='text', help='Output format')
    parser.add_argument('-l', '--list', action='store_true', help='List all paramaters under same level path')
    parser.add_argument('-r', '--recursive', action='store_true', help='Process all paramaters recursively starting from path')
    parser.add_argument('--delete', action='store_true', help='Delete a single parameter or all parameters recursively starting from path if using --recursive')
